    ...
    public void onBindViewHolder(RecyclerViewHolder_Hiring holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intenthiring = new Intent(v.getContext(), ContentHiringActivity.class);
                intenthiring.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                context.startActivity(intenthiring);
            }
        });
    }
